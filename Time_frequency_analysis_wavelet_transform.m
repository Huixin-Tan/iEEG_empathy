...
cfg.toi = data.time{1,1}(1)+3:0.01:data.time{1,1}(end)-3; %downsample to 100Hz, remove 3s data padded before and after the data series
cfg.width=[linspace(3,6,34) linspace(6,12,24)];
E1_data_TF = ft_freqanalysis(cfg, data);
